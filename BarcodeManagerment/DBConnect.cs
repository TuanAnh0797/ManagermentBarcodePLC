...
namespace BarcodeManagerment
{
    ...
    {
        //public static string connection_string = "Data Source=DESKTOP-NP52VJJ\\SQLEXPRESS;Initial Catalog=managermentbarcode;Integrated Security=True";


        public static string connection_string = "Data Source=DESKTOP-CEVMTEM\\SQLEXPRESS;Initial Catalog=managermentbarcode;Integrated Security=True";
